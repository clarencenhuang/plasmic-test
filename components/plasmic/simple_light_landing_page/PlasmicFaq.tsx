...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: sWQYXivNXUbD5Y/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__c562W)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__wvF7E)}>
          <div className={classNames(projectcss.all, sty.freeBox___01PfU)}>
            {p.renderPlasmicSlot({
