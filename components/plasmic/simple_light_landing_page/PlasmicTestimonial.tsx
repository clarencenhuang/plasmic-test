...
import Avatar from "../../Avatar"; // plasmic-import: Kkh0xhp6LPG2B5/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: q2dK0gYKTHMCa3/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: y9XxACsPhPLM_V/icon
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__ivXt9)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__chse)}
        >
          <div
            className={classNames(
              projectcss.all,
