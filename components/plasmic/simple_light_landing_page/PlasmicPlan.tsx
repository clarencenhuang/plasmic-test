...
import BaseCard from "../../BaseCard"; // plasmic-import: F1yYJZULtOoD7D/component
...
import sty from "./PlasmicPlan.module.css"; // plasmic-import: WWmf6zo5Most4S/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__a534X)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__tmSG)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__qvC0C)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__mdi8B)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__lo4Dh)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__kZsOc)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(projectcss.all, sty.freeBox__sSjyg)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__or1Wv)}
